  ...
  return (
    <div className="info-wrapper">
      ...
      <ul className="guide">
        ...
        <li>입실시간: 오후3시 <span className="main-color">퇴실시간: 오전 11시</span></li>
        <li>예약된 인원 외 다른사람의 방문을 제한합니다.</li>
        <li>입실이 불가능하며 당일 예약 취소와 동일시 되는 상황 : 예약된 인원 이상 왔을 때, 애완동물과 동반입실할 때</li>
        <li><span className="main-color">객실 내에서 해산물 및 고기요리와 튀김류 조리는 다음손님을 위해 삼가해주시기 바랍니다.</span></li>
        <li>시설물 훼손 및 분실시 책임은 고객님께 부과하오니 객실사용에 신경써 주시기 바랍니다.</li>
        <li><span className="main-color">부주의로 인해 일어난 안전사고, 귀중품(현금포함) 분실 및 파손에 대해서는 펜션에 책임을 물을 수 없습니다.</span></li>
